...
public class BlockShatteredMountain extends Block{
	...
	public BlockShatteredMountain(int par1) {
	...
	{
		this.blockIcon = par1IconRegister.registerIcon(MountainGen.modid + ":mountainShatteredGenBlock");
	}
